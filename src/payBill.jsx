    ...
    return(
        <div className='m-5'>
            ...
            <div className='flex gap-10 flex-col'>
                ...
                <Container title="Water bill" description="Pay Water bill this month" image={water} />
                <Container title="Internet bill" description="Pay internet bill this month" image={internet} />
            </div>
